...
public class LocationConfiguratorFactory {
  ...
  public ILocationConfiguratorPlugin newInstance(String locationType) {
    ...
    if (OpenNebulaLocationConfigurator.LOCATION_TYPE.equals(locationType)) {
      OpenNebulaLocationConfigurator configurator = applicationContext.getBean(OpenNebulaLocationConfigurator.class);
      return configurator;
