...
public class LocationConfiguratorFactory {
  ...
  public ILocationConfiguratorPlugin newInstance(String locationType) {
    ...
    if (OpenNebulaLocationConfiguration.LOCATION_TYPE.equals(locationType)) {
      OpenNebulaLocationConfiguration configurator = applicationContext.getBean(OpenNebulaLocationConfiguration.class);
      return configurator;
    } else if (OpenStackLocationConfigurator.LOCATION_TYPE.equals(locationType)) {
      OpenStackLocationConfigurator configurator = applicationContext.getBean(OpenStackLocationConfigurator.class);
      return configurator;
    }
    return null;
