...
import es.upv.indigodc.alien4cloud.im.plugin.AuthorizationFileNotFoundException;
import es.upv.indigodc.alien4cloud.im.plugin.configuration.CloudConfiguration;
import es.upv.indigodc.alien4cloud.im.plugin.configuration.CloudConfigurationBase;
...
//  }
  ...
  protected Map<String, String> generateHeaders(CloudConfigurationBase cloudConf,
                                                DeploymentTopology deploymentTopology) throws AuthorizationFileNotFoundException, IOException {
